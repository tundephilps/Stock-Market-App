...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=ch5vuq1r01qo6f5d2brgch5vuq1r01qo6f5d2bs0`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=ch5vuq1r01qo6f5d2brgch5vuq1r01qo6f5d2bs0`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=ch5vuq1r01qo6f5d2brgch5vuq1r01qo6f5d2bs0`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=ch5vuq1r01qo6f5d2brgch5vuq1r01qo6f5d2bs0`;
  const response = await fetch(url);
